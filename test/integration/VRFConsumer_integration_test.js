...
describe('VRF Integration Test', () => {
    ...
    it('Should make a VRF request', async () => {
        const accounts = await ethers.getSigners()
        const signer = accounts[0]
        const linkTokenContract = new ethers.Contract('0xa36085F69e2889c224210F603D836748e7dC0088', LinkTokenABI, signer)

        let transferTransaction = await linkTokenContract.transfer(vRFConsumer.address, '1000000000000000000')
